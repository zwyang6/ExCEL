...
def crf_proc():
    ...
    images_path = os.path.join(args.data_folder, f'JPEGImages/{args.infer_set}',)
    labels_path = os.path.join(args.data_folder, f'SegmentationClass/{args.infer_set}')
    ...
    def _job(i):
        ...
        logit_name = args.logits_dir + "/" + name[13:] + ".npy"
...
if __name__ == "__main__":
    ...
    ### for test 
    if args.infer_set == 'test':
        args.test_segs_dir = os.path.join(base_dir, f"{args.infer_set}_{cpt_name}_segs/results/VOC2012/Segmentation/comp6_test_cls/")
